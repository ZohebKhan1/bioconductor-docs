...
-   *oarfish* [(Jousheghani and Patro 2024)]
...
```
sgnex_file <- "sgnex_h9"
files <- file.path(dir, "oarfish", paste0(sgnex_file, "_rep", 2:4, ".quant.gz"))
...
```
    ...
    ## [12] Biobase_2.70.0
    ## [13] GenomicRanges_1.62.1
    ## [14] Seqinfo_1.0.0
    ## [15] IRanges_2.44.0
    ## [16] S4Vectors_0.48.0
    ## [17] BiocGenerics_0.56.0
    ## [18] generics_0.1.4
    ## [19] tximportData_1.38.0
    ## [20] knitr_1.51
    ##
    ## loaded via a namespace (and not attached):
    ##  [1] tidyselect_1.2.1         dplyr_1.1.4              farver_2.1.2
    ##  [4] blob_1.2.4               S7_0.2.1                 Biostrings_2.78.0
    ##  [7] bitops_1.0-9             fastmap_1.2.0            RCurl_1.98-1.17
    ## [10] GenomicAlignments_1.46.0 XML_3.99-0.20            digest_0.6.39
    ## [13] lifecycle_1.0.4          statmod_1.5.1            KEGGREST_1.50.0
    ## [16] RSQLite_2.4.5            magrittr_2.0.4           compiler_4.5.2
    ## [19] rlang_1.1.6              sass_0.4.10              tools_4.5.2
    ## [22] utf8_1.2.6               yaml_2.3.12              rtracklayer_1.70.1
    ## [25] S4Arrays_1.10.1          bit_4.6.0                curl_7.0.0
    ## [28] DelayedArray_0.36.0      RColorBrewer_1.1-3       abind_1.4-8
    ## [31] BiocParallel_1.44.0      grid_4.5.2               Rhdf5lib_1.32.0
    ## [34] ggplot2_4.0.1            scales_1.4.0             dichromat_2.0-0.1
    ## [37] cli_3.6.5                rmarkdown_2.30           crayon_1.5.3
    ## [40] otel_0.2.0               httr_1.4.7               tzdb_0.5.0
    ## [43] rjson_0.2.23             DBI_1.2.3                cachem_1.1.0
    ## [46] rhdf5_2.54.1             parallel_4.5.2           formatR_1.14
    ## [49] XVector_0.50.0           restfulr_0.0.16          vctrs_0.6.5
    ## [52] Matrix_1.7-4             jsonlite_2.0.0           hms_1.1.4
    ## [55] bit64_4.6.0-1            archive_1.1.12           locfit_1.5-9.12
    ## [58] jquerylib_0.1.4          glue_1.8.0               codetools_0.2-20
    ## [61] gtable_0.3.6             BiocIO_1.20.0            tibble_3.3.0
    ## [64] pillar_1.11.1            htmltools_0.5.9          rhdf5filters_1.22.0
    ## [67] R6_2.6.1                 vroom_1.6.7              evaluate_1.0.5
    ## [70] lattice_0.22-7           png_0.1-8                Rsamtools_2.26.0
    ## [73] cigarillo_1.0.0          memoise_2.0.1            bslib_0.9.0
...
Jousheghani, Zahra Zare, and Rob Patro. 2024. "Oarfish: Enhanced Probabilistic Modeling Leads to Improved Accuracy in Long Read Transcriptome Quantification." *bioRxiv*. <https://doi.org/10.1101/2024.02.28.582591>.
