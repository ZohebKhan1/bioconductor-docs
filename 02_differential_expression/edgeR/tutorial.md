...
Documentation for specific functions is available through the usual R help system, e.g., `?glmFit`. Further questions about the package should be directed to the [Bioconductor support site](https://support.bioconductor.org).
